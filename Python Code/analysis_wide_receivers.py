...
def calculate_similarity_scores_by_age(devianceList):
    '''
    Description:
...
# Import the WR Data
df = pd.read_csv('WIDE_RECEIVER.csv', dtype = {'team_pic_url': str, 'high_school_state':str})

# Identify the columns we want to fill in missing values for and replace them
#   with 0's
stats_list = []
...
# Roll up all deviance scores between all players into one final dictionary
devianceDict = calculate_similarity_scores_by_age(devianceList)